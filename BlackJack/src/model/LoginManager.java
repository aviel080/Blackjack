...
public class LoginManager {
	...
	public User userLogin(StringBuilder userName,StringBuilder password) throws Exception
	{
		users = FileManager.read();
		User fileUser = userExists(userName.toString());
		passwordMatch(fileUser, password.toString());
		return fileUser;
	}
